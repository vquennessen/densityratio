...
#'
#' @examples
#' initialize_arrays(A = 5, Time1 = 50, Time2 = 20, R0 = 1e+5, Rec_age = 2,
#'    Max_age = 35, A1 = 5, L1 = 32.21, A2 = 15, L2 = 47.95, K = 0.2022,
#'    WA = 1.68e-5, WB = 3, K_mat = -0.4103, Fb = 0.2, L50 = 39.53,
...
initialize_arrays <- function(A = 5, Time1 = 50, Time2 = 20, R0 = 1e+5, Rec_age,
                              Max_age, A1, L1, A2, L2, K, WA, WB, K_mat, Fb,
                              L50, Sigma_R, Rho_R = 0, Fleets, Alpha, A50_up,
                              A50_down, F_fin, Beta, Cf, R, X, SP, M,
                              Control_rules, Phi, Stochasticity = TRUE,
