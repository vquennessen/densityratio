...
A = 5; MPA = 3
Time1 = 50; Time2 = 50
M_Error = 0; Sampling_Error = TRUE; Stochasticity = FALSE
...
Output.N = FALSE; Output.Abundance = FALSE; Output.Biomass = FALSE; 
Output.SSB = TRUE; Output.Yield = TRUE; Output.Effort = TRUE; 
  ...
  for (am in 1:length(Adult_M)) {
    for (a in 1:length(Allocations)) {
      ...
      output <- base_model(Species, R0, A, MPA, Time1, Time2, 
                           ...
                           Allocation, BM, LDP, Control_rules,Output.N, 
